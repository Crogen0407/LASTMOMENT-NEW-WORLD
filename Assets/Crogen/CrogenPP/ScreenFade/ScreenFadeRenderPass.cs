...
public class ScreenFadeRenderPass : ScriptableRenderPass
{
    protected const string TEMP_BUFFER_NAME = "_TempColorBuffer";
   
    protected ScreenFade Component;
    protected string RenderTag { get; }
    
    private RenderTargetIdentifier _source;
    private RenderTargetHandle _tempTexture;
    
    public ScreenFadeRenderPass(string renderTag, RenderPassEvent passEvent) 
    {
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        if(Component==null)
            Component = volumeStack.GetComponent<ScreenFade>();
